	...
	for sd=100,118 do
		...
		if sd ~= 102 and sd ~=8  then
			...
			if s1 >0 then
				...
				if a == "ti" then
					ti  = ti + x892002_g_DWtable[s1]
				elseif a == "lt" then
					lt =lt + x892002_g_DWtable[s1]
				elseif a == "ll" then
					ll =ll + x892002_g_DWtable[s1]
				elseif a == "sf" then
					sf =sf + x892002_g_DWtable[s1]
				elseif a == "bg" then
			...
			if s2 >0 then
				...
				if a == "ti" then
					tis  = tis + x892002_g_DWtable[s2]
				elseif a == "lt" then
					lts =lts + x892002_g_DWtable[s2]
				elseif a == "ll" then
					lls =lls + x892002_g_DWtable[s2]
				elseif a == "sf" then
					sfs =sfs + x892002_g_DWtable[s2]
				elseif a == "bg" then
...
function x892002_AHa_ReMyBuff(sceneId, selfId)  --函数入口
	...
	--目前来说属性步长10，属性攻击15
	for i=1,4 do
		x892002_SetAbility(sceneId,selfId,x892002_g_numToChar[i],NewBuff[i] * 15 + DWBuff[i+16])
	end
	local dw = {DWBuff[23],DWBuff[22],DWBuff[21],0,DWBuff[24]}
	for i=13,17 do
		x892002_SetAbility(sceneId,selfId,x892002_g_numToChar[i],NewBuff[i] * 10 + dw[i-12])
	end
...
function x892002_GetZhenYuan(sceneId, selfId) --真元
	...
	x892002_g_adddsuxingvalue[1] = {10,{10,20,30,40,50,60,70,80,90,"真元·勇力","力量"},{20,40,60,80,100,120,120,160,180,"真元·勇力","力量"},{30,60,90,120,150,180,210,240,270,"真元·勇力","力量"},{40,80,120,160,200,240,280,320,360,"真元·勇力","力量"},{50,100,150,200,250,300,350,400,450,"真元·勇力","力量"}}
	x892002_g_adddsuxingvalue[2] = {10,{10,20,30,40,50,60,70,80,90,"真元·灵慧","灵气"},{20,40,60,80,100,120,120,160,180,"真元·灵慧","灵气"},{30,60,90,120,150,180,210,240,270,"真元·灵慧","灵气"},{40,80,120,160,200,240,280,320,360,"真元·灵慧","灵气"},{50,100,150,200,250,300,350,400,450,"真元·灵慧","灵气"}}
	x892002_g_adddsuxingvalue[3] = {10,{10,20,30,40,50,60,70,80,90,"真元·厚体","体力"},{20,40,60,80,100,120,120,160,180,"真元·厚体","体力"},{30,60,90,120,150,180,210,240,270,"真元·厚体","体力"},{40,80,120,160,200,240,280,320,360,"真元·厚体","体力"},{50,100,150,200,250,300,350,400,450,"真元·厚体","体力"}}
	x892002_g_adddsuxingvalue[4] = {10,{10,20,30,40,50,60,70,80,90,"真元·气定","定力"},{20,40,60,80,100,120,120,160,180,"真元·气定","定力"},{30,60,90,120,150,180,210,240,270,"真元·气定","定力"},{40,80,120,160,200,240,280,320,360,"真元·气定","定力"},{50,100,150,200,250,300,350,400,450,"真元·气定","定力"}}
	x892002_g_adddsuxingvalue[5] = {10,{10,20,30,40,50,60,70,80,90,"真元·迅捷","身法"},{20,40,60,80,100,120,120,160,180,"真元·迅捷","身法"},{30,60,90,120,150,180,210,240,270,"真元·迅捷","身法"},{40,80,120,160,200,240,280,320,360,"真元·迅捷","身法"},{50,100,150,200,250,300,350,400,450,"真元·迅捷","身法"}}
	...
	x892002_g_adddsuxingvalue[16] = {15,{15,30,45,60,75,90,105,120,135,"真元·沉冰","冰攻击"},{30,60,90,120,150,180,210,240,270,"真元·沉冰","冰攻击"},{45,90,135,180,225,270,315,360,405,"真元·沉冰","冰攻击"},{60,120,180,240,300,360,420,480,540,"真元·沉冰","冰攻击"},{75,150,225,300,375,450,525,600,675,"真元·沉冰","冰攻击"}}
	x892002_g_adddsuxingvalue[17] = {15,{15,30,45,60,75,90,105,120,135,"真元·炽火","火攻击"},{30,60,90,120,150,180,210,240,270,"真元·炽火","火攻击"},{45,90,135,180,225,270,315,360,405,"真元·炽火","火攻击"},{60,120,180,240,300,360,420,480,540,"真元·炽火","火攻击"},{75,150,225,300,375,450,525,600,675,"真元·炽火","火攻击"}}
	x892002_g_adddsuxingvalue[18] = {15,{15,30,45,60,75,90,105,120,135,"真元·印玄","玄攻击"},{30,60,90,120,150,180,210,240,270,"真元·印玄","玄攻击"},{45,90,135,180,225,270,315,360,405,"真元·印玄","玄攻击"},{60,120,180,240,300,360,420,480,540,"真元·印玄","玄攻击"},{75,150,225,300,375,450,525,600,675,"真元·印玄","玄攻击"}}
	x892002_g_adddsuxingvalue[19] = {15,{15,30,45,60,75,90,105,120,135,"真元·蛊毒","毒攻击"},{30,60,90,120,150,180,210,240,270,"真元·蛊毒","毒攻击"},{45,90,135,180,225,270,315,360,405,"真元·蛊毒","毒攻击"},{60,120,180,240,300,360,420,480,540,"真元·蛊毒","毒攻击"},{75,150,225,300,375,450,525,600,675,"真元·蛊毒","毒攻击"}}
